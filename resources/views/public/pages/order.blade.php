...
@section('css')
<link href="public/css/seat.css" rel='stylesheet' type='text/css' />
@endsection
@section('content')
<div class="wrap">
  <div class="content">
     ...
     <div class="content_top">
        <div>
           <h3 style="font-size: 25px; color: red; margin-left:2%">@lang('user/booking.booking_close') <span id="time"></span> @lang('user/booking.minutes')!</h3>
        </div>
     </div>
